...
import { createTweet, getTweet ,likefn ,comment , getComment ,deleteComment,deleteTweet,likeVal} from "../controller/tweets-controller.js";
...
tweetRouter.route("/likeCheck/:id").put(likeVal);
